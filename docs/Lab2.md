...
![Preview in QGIS Browser](figures/Lab2/Preview_in_QGIS_Browser.png "Preview in QGIS Browser")
...
![Attributes in QGIS Browser](figures/Lab2/Attributes_in_QGIS_Browser.png "Attributes in QGIS Browser")
...
![Raster data Preview](figures/Lab2/Raster_data_Preview.png "Raster data Preview")
...
![Folder Contents](figures/Lab2/Folder_contents.png "Folder Contents")
...
![QGIS Desktop](figures/Lab2/QGIS_Desktop.png "QGIS Desktop")
...
![Close Browser Panel Button](figures/Lab2/Close_Browser_Panel_Button.png "Close Browser Panel Button")
...
![Area to Drag When Undocking a Panel](figures/Lab2/Panel_Dragging_Area.png "Area to Drag When Undocking a Panel")
...
![Docking the Layers Panel](figures/Lab2/Docking_Layers_Panel.png "Docking the Layers Panel")
...
![Add Vector Layer](figures/Lab2/Add_Vector_Layer1.png "Add Vector Layer")
...
![OGR Supported Vector Formats](figures/Lab2/OGR_Supported_Vector_Formats.png "OGR Supported Vector Formats")
...
![Open an OGR Supported Vector Layer](figures/Lab2/Open_an_OGR_Supported_Vector_Layer.png "Open an OGR Supported Vector Layer")

8. Now back at the Add vector layer window and click Open to add the data to QGIS Desktop (see figure below).

![Add vector layer – Hawaii Counties](figures/Lab2/Add_vector_layer-Hawaii_Counties.png "Add vector layer – Hawaii Counties")
...
![Layer Context Menu](figures/Lab2/Layer_Context_Menu.png "Layer Context Menu")
...
![Attribute Table](figures/Lab2/Attribute_Table.png "Attribute Table")

12. Another way to interact with both the spatial features and the attributes is the Identify button.
13. Click the Identify button ![Identify Button](figures/Lab2/Identify_Button.png "Identify Button")
...
![Identify Results](figures/Lab2/Identify_Results.png "Identify Results")

Now you will learn how to add Raster data to QGIS Desktop.

1. Click the Add Raster Layer button ![Add Raster Layer button](figures/Lab2/Add_Raster_Layer_button.png "Add Raster Layer button")
...
![Open a GDAL Supported Raster Data Source](figures/Lab2/Open_a_GDAL_Supported_Raster_Data_Source.png "Open a GDAL Supported Raster Data Source")
...
![[GDAL] All Files](figures/Lab2/[GDAL]_All_Files.png "[GDAL] All Files")
...
![[GDAL] JPEG 2000](figures/Lab2/[GDAL]_ERDAS_JPEG_2000.png "[GDAL] JPEG 2000")
...
![Zoom to Layer](figures/Lab2/Zoom_to_Layer_Extent.png "Zoom to Layer")
...
![Adding a GRID to QGIS](figures/Lab2/Adding_a_GRID_to_QGIS.png "Adding a GRID to QGIS")
...
![Toolbars and Windows Context Menu](figures/Lab2/Toolbars_and_Windows_Context_Menu.png "Toolbars and Windows Context Menu")
...
![Add as a Favourite](figures/Lab2/Add_as_a_Favourite.png "Add as a Favourite")
